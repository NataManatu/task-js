...
/*6. Напишите рекурсивную функцию, которая выводит число N «справа налево», то есть последняя
цифра числа становится первой, предпоследняя —
второй и т.д. (например, ввод N=123, вывод 321;
ввод N= 12, вывод 21). Обеспечьте ввод пользователем числа N и вывод его «справа налево» вызовом
функции. Подсказка: последняя цифра числа «х»
это остаток от деления на 10 (х%10), а остальные
цифры можно отделить, поделив «х» на 10 нацело
(parseInt(х/10)).*/